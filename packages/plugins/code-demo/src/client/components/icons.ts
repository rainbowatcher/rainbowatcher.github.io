...
export const BackIcon: FunctionalComponent = () => h(IconBase, { name: "back" }, () => h("path", {
...
export const HomeIcon: FunctionalComponent = () => h(IconBase, { name: "home" }, () => h("path", {
...
export const LoadingIcon: FunctionalComponent = () => h(IconBase, { name: "loading" }, () => ["0s", "-0.333s", "-0.667s"].map(item => h(
    "circle",
    {
        cx: 50,
        cy: 50,
...
export const TOGGLE_SVG
  = '<svg class="jsfiddle-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--ic" width="200" height="200" preserveAspectRatio="xMidYMid meet"><path fill="#333" d="M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6l-6 6l1.41 1.41z"/></path></svg>'
