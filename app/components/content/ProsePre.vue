...
<template>
    ...
    <template v-else>
        <div class="group code-pre relative overflow-auto bg-popover lt-sm:mx--6 sm:rounded-lg">
            ...
            <div class="code-copy absolute right-2.5 top-2.5 hidden cursor-pointer b b-ring rounded-md bg-muted/10 px-2 py1 op-0 blur transition-opacity duration-300 ease-in-out active:bg-muted/10 hover:bg-muted/20 group-hover:(op-100 blur-none)" />
            <pre
