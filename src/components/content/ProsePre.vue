...
<template>
    ...
    <template v-else>
        <div class="group code-pre relative overflow-auto bg-popover lt-sm:mx--6 sm:rounded-lg">
            ...
            <div class="code-copy absolute right-2.5 top-2.5 hidden cursor-pointer b b-border rounded bg-[hsl(from_var(--muted)_h_s_l_/10%)] px-2 py1 op-0 blur transition-opacity duration-300 ease-in-out active:bg-[hsl(from_var(--muted)_h_s_l_/10%)] hover:bg-[hsl(from_var(--muted)_h_s_l_/5%)] group-hover:(op-100 blur-none)" />
            <pre
